...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittests for testing prompting of the AirBnB command interpreter."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unittests for testing help messages of the AirBnB command interpreter."""

    def test_help_quit(self):
        h = "Quit command to quit the program."
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_EOF(self):
        h = "EOF signal to quit the program."
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests for testing exiting from the AirBnB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittests for testing create from the AirBnB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Unittests for testing show from the AirBnB command interpreter"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests for testing destroy from the AirBnB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Unittests for testing all of the AirBnB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests for testing update from the AirBnB command interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """Unittests for testing the count method of AirBnB comand interpreter."""
